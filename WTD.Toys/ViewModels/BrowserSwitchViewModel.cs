...
using WTD.Toys.Utils;

namespace WTD.Toys.ViewModels;

public partial class BrowserSwitchViewModel : ObservableObject, INavigationAware
{
    private const string AppName = "WTD.Toys Browser Switcher";
    private const string AppId = "WTD.Toys.BrowserSwitcher";
